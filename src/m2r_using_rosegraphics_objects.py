...
#                a Square, and a Polygon

#
#          -- Write the names of three METHODs that Circle objects have:
#                Clone, attach_to, detach from
#
...
#            it determines how many seconds the render pauses
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            when you need to look at the final product of the window
#
